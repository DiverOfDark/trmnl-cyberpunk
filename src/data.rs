        ...
        Self {
            ...
            weather: Some(WeatherData {
                ...
                hourly: vec![
                    ...
                    WeatherHour { time: "13:00".into(), temp_c: 15, cond: "RAIN".into()  },
                    WeatherHour { time: "14:00".into(), temp_c: 15, cond: "CLOUD".into() },
                    WeatherHour { time: "15:00".into(), temp_c: 16, cond: "CLOUD".into() },
                    WeatherHour { time: "16:00".into(), temp_c: 14, cond: "SUN".into()   },
                    WeatherHour { time: "17:00".into(), temp_c: 13, cond: "RAIN".into()  },
                ],
                forecast: vec![
                    ...
                    WeatherDay { day: "MON".into(), hi: 15, lo:  8, cond: "FOG".into()   },
                    WeatherDay { day: "TUE".into(), hi: 17, lo:  9, cond: "CLOUD".into() },
                    WeatherDay { day: "WED".into(), hi: 22, lo: 13, cond: "SUN".into()   },
                    WeatherDay { day: "THU".into(), hi: 20, lo: 12, cond: "SNOW".into()  },
                ],
            }),
            agenda: vec![
